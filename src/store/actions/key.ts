...
export const createFetchKeySuccessfulAction = (key: string): FETCH_KEY_SUCCESSFUL_ACTION => ({
...
export const createSaveKeySuccessfulAction = (key: string): SAVE_KEY_SUCCESSFUL_ACTION => ({
