...
export type NotificationAction = SHOW_NOTIFICATION_ACTION | HIDE_NOTIFICATION_ACTION
...
export const notification = (state: NotificationState = initialNotificationState, action: Action): NotificationState => {
    switch(action.type) {
