...
const getLogs = (date: string, userId: any, settings: ILoginSettings, key: string, onSuccess: Function, onError?: Function) => {
...
const baseBodyLogRequest = (form: ILogs, settings: ILoginSettings, key: string, onSuccess: BaseBodyLogRequestOnSuccessFunction, onError: Function) => {
    ...
    return (endpoint: string, method: string) => (fetchAPI<IExternalLog, ILogs>({
...
const createLog = (
    ...
    const method = "POST";
    return baseBodyLogRequest(body, settings, key, onSuccess, onError)(endpoint, method);
};
